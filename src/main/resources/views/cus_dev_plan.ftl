...
<body style="margin: 1px">
    <table id="dg" class="easyui-datagrid"
        ...
        <tr>
            ...
            <th field="linkMan" width="200" align="center">联系人</th>
            <th field="linkPhone" width="300" align="center">联系电话</th>
            ...
            <th field="op" formatter="formatterOp">操作</th><#--虚构的列-->
        </tr>
        </thead>
    </table>
    <div id="tb">
    ...
    <#--对话框-->
    <div id="dlg" class="easyui-dialog" style="width:800px;height:600px"
         closed="true" >
        <#--营销机会详情展示-->
        <div id="p" class="easyui-panel"  style="width: 800px;height: 400px;padding: 10px">
            <form id="fm">
        ...
        <#--可修改表格-->
        <#--开发计划详情记录-->
        <table id="dg02" class="easyui-datagrid" style="width:800px;height:250px" title="开发计划项"
               data-options="fitColumns:true,singleSelect:true,pagination:true,rownumbers:true" toolbar="#toolbar01">
            <thead>
            <tr>
